#!/bin/bash
echo "start publish"
dotnet publish /projects/CountrymenFund-webapi/src/Host/Host.csproj -r linux-x64 - published
dotnet publish /projects/CountrymenFund-wasm/src/Host/Host.csproj -r linux-x64 - published
