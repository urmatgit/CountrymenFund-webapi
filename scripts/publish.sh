...
dotnet publish -c Release -r linux-x64 --self-contained true -p:PublishTrimmed=false -f net7.0 -o published /projects/CountrymenFund-wasm/src/Host/Host.csproj
